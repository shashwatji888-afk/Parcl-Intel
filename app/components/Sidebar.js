...
export default function Sidebar({ onOpenUpgrade, onOpenProfile }) {
  ...
  return (
    <aside style={{ width: '220px', backgroundColor: '#070709', borderRight: '1px solid rgba(255, 255, 255, 0.18)', height: 'calc(100vh - 82px)', display: 'flex', flexDirection: 'column', position: 'fixed', top: '82px', left: 0, zIndex: 40, overflowY: 'auto' }}>
